...
def create_note(request: schemas.Note, user_id: int = Path(example='Enter user ID'), title: str = Query(example='Your title here', description='Title', max_length=50), db: Session = Depends(get_db)):
